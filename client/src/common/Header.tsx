            ...
            <div className="top-header__container">
                ...
                <div>
                    ...
                    <div className="mobile-mode-toggle">
                        ...
                        <label className="switch">
                            <input type="checkbox" name="mobile-mode-toggle" className="theme-toggle-input" onChange={_ => toggleMobileMode()} checked={theme.buttonMode}/>
                            <span className="slider round"></span>
                        </label>
                        <svg width="288" height="449" viewBox="0 0 288 449" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="288" height="449" rx="27" fill="black"/><rect x="113" y="368" width="62" height="32" rx="16" fill="white"/></svg>
                    </div>
